...
//! This example demonstrates how to use the Copilot provider with a system prompt.
//!
...
//!
//! Usage:
//! `cargo run --example copilot_system_prompt_example --features copilot`
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Create a new LLM provider with the Copilot backend and a system prompt.
    ...
    let provider = LLMBuilder::new()
        ...
        .system("You are a helpful geography assistant. Always provide accurate information about world capitals and include an interesting fact about the city.")
    ...
    println!("System prompt: \"You are a helpful geography assistant. Always provide accurate information about world capitals and include an interesting fact about the city.\"");
